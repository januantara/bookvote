...
const ProfileHeader = () => {
    ...
    const joinedAt = new Date(user?.createdAt || new Date());
        ...
        <div className="border-b h-72 flex items-center px-20 relative">
            ...
            <div className="profile flex gap-10">
                ...
                <div className="profile-info mt-1">
                    ...
                    <h4 className='opacity-80 mt-px mb-2'>Member sejak {joinedAt.toLocaleDateString(undefined, {
                        month: 'long',
                        year: 'numeric'
                    })}</h4>
                    <p className='flex text-sm items-center gap-1.5 opacity-80'><Mail size={16} />ajanuantara@gmail.com</p>
